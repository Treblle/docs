...
Your first step should be to register Treblle as an alias in your `app/Http/Kernel.php`:
...
If you have problems of any kind feel free to reach out via [treblle.com](https://treblle.com) or email vedran@treblle.com, and we'll
